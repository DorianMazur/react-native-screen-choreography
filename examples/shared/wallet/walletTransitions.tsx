...
function TokenMotion({ children, source, target, progress, direction, zIndex }: TransitionRendererProps) {
  return <TransitionFrame sourceMetrics={source.metrics} targetMetrics={target.metrics} progress={progress} direction={direction} zIndex={zIndex}>{children}</TransitionFrame>;
}
